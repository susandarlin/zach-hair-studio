...
Use template from `D:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `D:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/UI-SPEC.md`
