...
<!-- For checkpoint task examples and patterns, see @D:/repos/vct/zach-hair-studio/.claude/gsd-core/references/checkpoints.md -->
...
See `D:/repos/vct/zach-hair-studio/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/repos/vct/zach-hair-studio/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
