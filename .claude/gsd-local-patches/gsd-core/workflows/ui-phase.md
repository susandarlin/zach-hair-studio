...
```markdown
Read D:/repos/vct/zach-hair-studio/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/repos/vct/zach-hair-studio/.claude/agents/gsd-ui-checker.md for instructions.
