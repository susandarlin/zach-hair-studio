...
```
Agent(
  prompt="Read D:/repos/vct/zach-hair-studio/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/SECURITY.md`
