...
INSTALL_JS_GLOBAL="D:/repos/vct/zach-hair-studio/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/repos/vct/zach-hair-studio/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
