...
@D:/repos/vct/zach-hair-studio/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/repos/vct/zach-hair-studio/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/repos/vct/zach-hair-studio/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/repos/vct/zach-hair-studio/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
