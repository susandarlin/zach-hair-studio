...
<!-- For checkpoint task examples and patterns, see @C:/repos/vct/zach-hair-studio/.claude/gsd-core/references/checkpoints.md -->
...
See `C:/repos/vct/zach-hair-studio/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/repos/vct/zach-hair-studio/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
