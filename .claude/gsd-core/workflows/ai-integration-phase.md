...
```markdown
Read C:/repos/vct/zach-hair-studio/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/repos/vct/zach-hair-studio/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/repos/vct/zach-hair-studio/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/repos/vct/zach-hair-studio/.claude/agents/gsd-eval-planner.md for instructions.
