...
```markdown
Read C:/repos/vct/zach-hair-studio/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/repos/vct/zach-hair-studio/.claude/agents/gsd-ui-checker.md for instructions.
...
@C:/repos/vct/zach-hair-studio/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / C:/repos/vct/zach-hair-studio/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "C:/repos/vct/zach-hair-studio/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "C:/repos/vct/zach-hair-studio/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
