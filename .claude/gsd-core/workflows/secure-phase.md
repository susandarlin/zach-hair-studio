...
```
Agent(
  prompt="Read C:/repos/vct/zach-hair-studio/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/SECURITY.md`
