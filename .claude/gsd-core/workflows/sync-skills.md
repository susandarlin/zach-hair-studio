...
INSTALL_JS_GLOBAL="C:/repos/vct/zach-hair-studio/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/repos/vct/zach-hair-studio/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
