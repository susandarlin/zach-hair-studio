...
<execution_context>
@C:/repos/vct/zach-hair-studio/.claude/gsd-core/workflows/smart-entry.md
...
<process>
Follow C:/repos/vct/zach-hair-studio/.claude/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
