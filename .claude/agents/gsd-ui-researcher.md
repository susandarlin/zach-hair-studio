...
Use template from `C:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `C:/repos/vct/zach-hair-studio/.claude/gsd-core/templates/UI-SPEC.md`
