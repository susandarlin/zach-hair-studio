...
public class ServiceUpdateDtoValidatorTests
{
    private readonly ServiceUpdateDtoValidator _validator = new();
    ...
    [Fact]
    public void Validate_WhenDisplayOrderIsZero_DoesNotHaveValidationError()
    {
        var dto = CreateValidDto();
        dto.DisplayOrder = 0;
    ...
    private static ServiceUpdateDto CreateValidDto()
        => new()
        {
            Slug = "precision-cut",
            Name = "Precision Cut",
